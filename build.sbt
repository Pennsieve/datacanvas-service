...
lazy val scripts = project
  ...
  .dependsOn(server)
  .settings(
    name := "datacanvas-service-scripts",
    headerLicense := headerLicenseValue,
    headerMappings := headerMappings.value + headerMappingsValue,
    libraryDependencies ++= Seq(
      "io.circe" %% "circe-core" % circeVersion,
...
lazy val server = project
  ...
  .settings(
    ...
    guardrailTasks in Compile := List(
      Server(file("swagger/datacanvas-service.yml"), pkg="com.pennsieve.datacanvas.server")
    ),
    ...
    coverageExcludedPackages := "com.pennsieve.datacanvas\\..*;",
...
lazy val client = project
  ...
  .settings(
    ...
    publishMavenStyle := true,
    guardrailTasks in Compile := List(
      Client(file("./swagger/datacanvas-service.yml"), pkg="com.pennsieve.datacanvas.client")
    ),
  )
